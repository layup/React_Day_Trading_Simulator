...
const DashboardLayuout = () => {
  return (
    <div className='bg-neutral-300 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 grid-rows-8 gap-4 p-4 w-full h-screen  mt-16 md:ml-16 md:mt-0 lg:ml-48 xl:ml-64 auto-rows-fr'>
