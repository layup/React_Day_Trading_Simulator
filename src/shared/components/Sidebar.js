  ...
  return (
    <div className='h-screen sticky top-0 w-1/5 md:w-2/6 xl:w-1/5'>
        <div className='bg-white h-full flex flex-col py-4'>
            <h1 className='basis-1/12 p-4 font-extrabold text-transparent text-xl bg-clip-text bg-gradient-to-r from-emerald-400 to-green-700'>Investment Simulator</h1>
            <ul  
